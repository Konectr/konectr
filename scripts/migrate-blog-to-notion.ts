/**
 * Blog Migration Script: Migrate existing blog posts to Notion
 *
 * Prerequisites:
 * 1. Create a Notion integration at https://www.notion.so/my-integrations
 * 2. Create a "Blog Posts" database in Notion with these properties:
 *    - Title (title) - default
 *    - Slug (text)
 *    - Excerpt (text)
 *    - Category (select): Company, Wellness, Tips, Activities, Stories, Features, Safety
 *    - Published Date (date)
 *    - Read Time (text)
 *    - Author (text)
 *    - Cover Image URL (url)
 *    - Published (checkbox)
 * 3. Connect the integration to your database (click ... → Connections → Add)
 * 4. Set environment variables:
 *    - NOTION_API_KEY=secret_xxx
 *    - NOTION_BLOG_DATABASE_ID=xxx
 *
 * Run with: npx tsx scripts/migrate-blog-to-notion.ts
 */
...
const blogPosts = [
  {
    ...
    excerpt: "The story behind our mission to bring real human connection back to the digital age.",
    category: "Companionship",
    publishedDate: "2025-01-15",
    readTime: "5 min read",
    author: "Konectr Team",
    coverImageUrl: "https://images.unsplash.com/photo-1539635278303-d4002c07eae3?w=800&q=80",
...
Ready to stop scrolling and start living?`,
  },
  {
    ...
    excerpt: "Understanding the modern loneliness crisis and why genuine human connection is more important than ever.",
    category: "Wellness",
    publishedDate: "2025-01-12",
    readTime: "7 min read",
    author: "Konectr Team",
    coverImageUrl: "https://images.unsplash.com/photo-1516575334481-f85287c2c82d?w=800&q=80",
    content: `## A Silent Crisis
...
And when you're ready for more, we'll be here.`,
  },
  {
    ...
    excerpt: "Practical tips for building genuine friendships after college, even when life gets busy.",
    category: "Tips",
...
Your future friends are out there looking for you too.`,
  },
  {
    ...
    excerpt: "Why cafes are ideal for meeting new people and how to make the most of your coffee meetup.",
    category: "Activities",
    publishedDate: "2025-01-08",
    readTime: "4 min read",
    author: "Konectr Team",
    coverImageUrl: "https://images.unsplash.com/photo-1453614512568-c4024d13c247?w=800&q=80",
    content: `## Why Coffee Shops?
...
Ready to find your coffee crew?`,
  },
  {
    ...
    excerpt: "How real people are using Konectr to build genuine friendships and create meaningful connections.",
    category: "Stories",
    publishedDate: "2025-01-05",
    readTime: "5 min read",
    author: "Konectr Team",
    coverImageUrl: "https://images.unsplash.com/photo-1543269865-cbf427effbad?w=800&q=80",
    content: `## Real Connections, Real Stories
...
Your story could be next.`,
  },
  {
    ...
    excerpt: "A deep dive into how Konectr matches you with people who share your energy and interests.",
    category: "Features",
    publishedDate: "2025-01-03",
    readTime: "6 min read",
    author: "Konectr Team",
    coverImageUrl: "https://images.unsplash.com/photo-1517048676732-d65bc937f952?w=800&q=80",
...
Pick an activity. See who shows up. Feel the difference.`,
  },
  {
    ...
    slug: "safety-first",
    excerpt: "Our commitment to creating a safe space for real-world connections and the measures we take to protect our community.",
    category: "Safety",
...
// Helper to convert markdown content to Notion blocks
  ...
  for (const line of lines) {
    ...
    if (trimmed.startsWith("## ")) {
      ...
      blocks.push({
        ...
        type: "paragraph",
        paragraph: {
          rich_text: [{ type: "text", text: { content: trimmed.slice(1, -1) }, annotations: { italic: true } }],
        },
      });
    } else {
      // Parse bold text
...
async function createBlogPost(post: typeof blogPosts[0]) {
...
async function main() {
  console.log("Starting blog migration to Notion...\n");

  if (!process.env.NOTION_API_KEY) {
    console.error("Error: NOTION_API_KEY environment variable not set");
    console.log("\nSet it with: export NOTION_API_KEY=secret_xxx");
    process.exit(1);
  }

  if (!process.env.NOTION_BLOG_DATABASE_ID) {
    console.error("Error: NOTION_BLOG_DATABASE_ID environment variable not set");
    console.log("\nSet it with: export NOTION_BLOG_DATABASE_ID=xxx");
    process.exit(1);
  }
  ...
  console.log("\n✅ Migration complete!");
  console.log("\nNext steps:");
  console.log("1. Check your Notion database to verify all posts");
  console.log("2. Update your .env.local with the credentials");
